    ...
    <div style={{ maxWidth: "640px", margin: "0 auto", padding: "5.5rem 24px" }}>
      ...
      <ul style={{ display: "flex", flexDirection: "column", gap: "0.75rem", listStyle: "none", padding: 0, margin: 0 }}>
        {discontinuedSites.map((site) => (
          <li key={site.name} style={{ display: "flex", alignItems: "baseline", gap: "0.75rem", flexWrap: "wrap" }}>
            <a href={site.archiveUrl} target="_blank" rel="noopener noreferrer" style={{
              fontSize: "0.9375rem", color: "var(--text-1)", fontWeight: 500,
            ...
            <span style={{
              ...
              textDecorationThickness: "1px", textDecorationColor: "var(--border)",
            }}>
