  ...
  return (
    <div style={{ maxWidth: "640px", margin: "0 auto", padding: "5.5rem 24px" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "1.375rem", marginBottom: "4rem" }}>
        {[
          <>I grew up in <span className="redact">[redacted]</span>, India. I studied computer science at SSN College of Engineering in Chennai and am now finishing a master&apos;s at UMass Amherst, focused on networks and security.</>,
