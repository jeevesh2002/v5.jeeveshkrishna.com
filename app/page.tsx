  ...
  return (
    <div style={{ maxWidth: "640px", margin: "0 auto", padding: "0 24px" }}>
      ...
      <section style={{ paddingTop: "7rem", paddingBottom: "5.5rem" }}>
        ...
        >
          I work on networks and security. I think about how technology and public policy shape
          civilization, and what it would take to get the long run right.
        </p>

        <div style={{ display: "flex", gap: "1.5rem", flexWrap: "wrap" }}>
          {heroLinks.map(({ label, href, icon, external }) => (
            <a
              key={label}
              href={href}
      ...
      <hr
        style={{ border: "none", borderTop: "1px solid var(--border)", marginBottom: "4.5rem" }}
      />
      ...
      <section style={{ marginBottom: "5rem" }}>
        ...
        {recentReads.map((item, i) => (
          ...
          >
            ...
            <p
              style={{ fontSize: "0.8125rem", color: "var(--text-3)", lineHeight: 1.55, margin: 0 }}
            >
              {item.description}
            </p>
          </a>
