...
export default function ReadingPage() {
  return (
    <div style={{ maxWidth: "860px", margin: "0 auto", padding: "5.5rem 24px" }}>
      ...
      <p style={{ marginTop: "4rem", fontSize: "0.8125rem", color: "var(--text-4)", lineHeight: 1.6 }}>
        Have a suggestion?{" "}
        <a href="mailto:jarigala@umass.edu" style={{ color: "var(--text-3)", textDecoration: "underline", textUnderlineOffset: "2px", textDecorationThickness: "1px" }}>
          Email me
        </a>.
      </p>
    </div>
